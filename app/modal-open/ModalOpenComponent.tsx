...
export default function ModalOpenComponent() {
  ...
  useEffect(() => {
    ...
    const photoWrappers = root.querySelectorAll(
      ".photo-wrapper",
    ...
    const songModal = root.querySelector(".song-modal") as HTMLElement | null;
    const songOpen = root.querySelector("#songOpen") as HTMLElement | null;
    const songClose = root.querySelector("#songClose") as HTMLElement | null;
    ...
    const photoShadows: HTMLElement[] = [];

    photoWrappers.forEach((item) => {
      const photo = item.querySelector(".photo") as HTMLElement | null;
      if (!photo) {
        return;
      }
    ...
    const handleSongOpenClick = () => {
      const distanceY =
        window.innerHeight -
        songOpen.getBoundingClientRect().bottom +
        content.offsetTop -
        390;
    ...
    songOpen.addEventListener("click", handleSongOpenClick);
    songClose.addEventListener("click", handleSongCloseClick);
    ...
    return () => {
      ...
      songOpen.removeEventListener("click", handleSongOpenClick);
      songClose.removeEventListener("click", handleSongCloseClick);
      window.removeEventListener("resize", updateSongModalPosition);
      photoShadows.forEach((node) => node.remove());
      resetState();
    };
  }, []);
          ...
          <div className="content">
            <div className="main-content">
              ...
              <div className="main-info">
                ...
                <div className="songs">
                  ...
                  <div className="song">
                    <p className="bold">Protector</p>
                    <p className="light">3:04</p>
                  </div>
                  <div className="song">
                    <p className="bold">My Rose</p>
                    <p className="light">0:53</p>
                  </div>
                  <div className="song">
                    <p className="bold">Smoke Hour ★ Willie Nelson</p>
            ...
            <div className="song-modal">
              ...
              <div className="song-modal-info">
                <div className="song-credits">
                  ...
                  >
                    <path
                      d="M5.70039 20.1004C5.20539 20.1004 4.78179 19.9243 4.42959 19.5721C4.07739 19.2199 3.90099 18.796 3.90039 18.3004V5.70039C3.90039 5.20539 4.07679 4.78179 4.42959 4.42959C4.78239 4.07739 5.20599 3.90099 5.70039 3.90039H18.3004C18.7954 3.90039 19.2193 4.07679 19.5721 4.42959C19.9249 4.78239 20.101 5.20599 20.1004 5.70039V18.3004C20.1004 18.7954 19.9243 19.2193 19.5721 19.5721C19.2199 19.9249 18.796 20.101 18.3004 20.1004H5.70039ZM5.70039 18.3004H8.62539V14.2504H8.40039C8.14539 14.2504 7.93179 14.164 7.75959 13.9912C7.58739 13.8184 7.50099 13.6048 7.50039 13.3504V5.70039H5.70039V18.3004ZM15.3754 18.3004H18.3004V5.70039H16.5004V13.3504C16.5004 13.6054 16.414 13.8193 16.2412 13.9921C16.0684 14.1649 15.8548 14.251 15.6004 14.2504H15.3754V18.3004ZM9.97539 18.3004H14.0254V14.2504H13.8004C13.5454 14.2504 13.3318 14.164 13.1596 13.9912C12.9874 13.8184 12.901 13.6048 12.9004 13.3504V5.70039H11.1004V13.3504C11.1004 13.6054 11.014 13.8193 10.8412 13.9921C10.6684 14.1649 10.4548 14.251 10.2004 14.2504H9.97539V18.3004Z"
                      fill="white"
                      fillOpacity="0.45"
                    />
                  </svg>
                  <p className="light">
                    Beyoncé, Jon Batiste <u>& 6 more</u>
                  </p>
                </div>
                <br />
                <p className="bold">
                  ‘AMERIICAN REQUIEM’ opens ‘COWBOY CARTER’ – Beyoncés eighth
                  studio album and the second part of her trilogy project that
                  began with the release of ‘RENAISSANCE’ in 2022.
                </p>
                <br />
                <p className="bold">
                  The song “American Requiem” sets the stage by calling out the
                  systemic racism that continues to oppress 60 years after the
                  Civil Rights Movement.“Nothing really ends/ for things to stay
                  the same, they have to change again/ Hello, my old friend/ You
                  changed your name but not the way you play pretend/ American
                  Requiem/ Them big ideas are buried here/ Amen.”
                </p>
                <br />
                <p className="bold">
                  Ta-Nehisi Coates has described American whiteness as “an
                  existential danger to the country and the world” and explains
                  how white Christian Nationalism conflates a whiteness that “is
                  neither national nor symbolic but is the very core of [its]
                  power… But whereas [its] forebears carried whiteness like an
                  ancestral talisman… [they have now] cracked the glowing amulet
                  open, releasing its eldritch energies.” Similarly in “American
                  Requiem,” Beyoncé calls on the listener to bury the “big
                  ideas” of the past – born from colonization and systemic
                  racism – and get ready for the truth she brings.
                </p>
              </div>
            ...
            <div className="modal">
              <div className="toggle">
                ...
                >
                  <path
                    d="M16.667 10.666H4.66699M10.667 4.66602V16.666"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="modal-content">
                <div className="photo-wrapper">
                  ...
                  <img
                    className="photo"
                    src="https://www.billboard.com/wp-content/uploads/2022/08/22-beyonce-cr-mason-poole-2022-billboard-1548.jpg?w=942&h=623&crop=1"
                  />
                </div>
                <div className="info">
